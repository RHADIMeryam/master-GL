...
public class HotelData {
	...
	public CommandLineRunner initDataHotel(HotelRepository hotelRepository) {
		...
		return args-> {
		    ...
		    logger.info("Preloding data hotel : "+hotelRepository.save(new Hotel("adagio", "france", "marseille", "avenue de fes",  3)));
		    logger.info("Preloding data hotel : "+hotelRepository.save(new Hotel("ibiza", "france", "paris", "impasse de l epi", 4)));
