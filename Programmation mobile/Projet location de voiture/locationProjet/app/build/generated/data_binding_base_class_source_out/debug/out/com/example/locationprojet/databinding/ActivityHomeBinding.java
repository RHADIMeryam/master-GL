...
public final class ActivityHomeBinding implements ViewBinding {
  ...
  private ActivityHomeBinding(@NonNull ConstraintLayout rootView,
      @NonNull BottomNavigationView bottomNavView, @NonNull ConstraintLayout wrapper) {
  ...
  public static ActivityHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ConstraintLayout wrapper = (ConstraintLayout) rootView;

      return new ActivityHomeBinding((ConstraintLayout) rootView, bottomNavView, wrapper);
    }
