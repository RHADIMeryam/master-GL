...
public class SessionManagerFragement extends Fragment {
    ...
    public SessionManagerFragement(Context contexte) {
    ...
    public SessionManagerFragement(ListAnnonceUtilisateur listAnnonceUtilisateur) {
        this.listAnnonceUtilisateur=listAnnonceUtilisateur;
        SharedPreferences preferences = this.getActivity().getSharedPreferences("userLoginSession", Context.MODE_PRIVATE);
        editor= userSession.edit();
    }
